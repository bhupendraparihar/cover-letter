...
function CoverLetter() {
  ...
  const copyToClipboard = () => {
    const text = (document.querySelector('.cover-letter') as HTMLInputElement)
      .innerText;
  ...
  return (
    <>
      <div className="preview cover-letter" contentEditable="true">
        <p>Hi,</p>

        <p>
          I am writing to express my keen interest in the {role} role at{' '}
          {orgName}, as advertised on LinkedIn. With over 14 years of experience
          in the field of Full Stack Development and a strong foundation in
          Computer Science, I am excited about the opportunity to contribute my
          expertise to your esteemed team.
        </p>

        <p>
          Throughout my journey, I have acquired in-depth knowledge of
          hand-coded HTML5, CSS3, and Object-Oriented JavaScript (OOJS),
          enabling me to craft seamless and engaging user experiences. My
          proficiency extends to various Front End Architecture paradigms,
          including Monolithic and Micro-Frontend approaches. I have
          successfully developed and deployed React applications, harnessing the
          power of state-management frameworks like Redux (leveraging
          middlewares such as Thunk/Saga) to ensure scalable and maintainable
          codebases.
        </p>
        ...
        <p>
          ...
          frameworks like Bootstrap, empowers me to create adaptive and
          accessible websites. My understanding of SEO and accessibility
          standards, along with my hands-on experience with client-side
          templating languages, contributes to building applications that are
        ...
        <p>
          ...
          believe my diverse experience aligns well with the needs of {orgName}.
          I am excited about the possibility of contributing to your projects
          and furthering the company's mission.
        </p>
        <p>
